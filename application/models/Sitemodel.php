...
class Sitemodel extends CI_Model{
	...
	public function getPagesAsMenu($parent,$position){
		...
		FROM `pages` m
		LEFT OUTER JOIN (SELECT `parent_id`,`page_url`, COUNT(*) AS Count FROM `pages` WHERE is_active="active" GROUP BY `parent_id`) D
	...
	public function track_page($data){
		$this->db->insert('page_tracker',$data);
	}
	
	public function get_row($table,$fieldname,$val)
    {
