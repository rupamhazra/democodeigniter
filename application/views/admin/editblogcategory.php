        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open(base_url() . "admin/update-blog-category/".$blogCategory['blog_category_id'], array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
					...
					<div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select name="inputParent" class="form-control col-md-7 col-xs-12">
								...
								<?php if(count($blogCategoryList)>0){foreach($blogCategoryList as $row){ ?>
								<option value="<?php echo $row['blog_category_id']?>" <?php if($row['blog_category_id']== $blogCategory['parent_id']) echo 'selected="selected"'; ?>><?php echo $row['category_name']?></option>	
								<?php }} ?>
							</select>
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" id="inputUrl" name="inputUrl" class="form-control col-md-7 col-xs-12 cForm" value="<?php echo $blogCategory['category_url']; ?>">
                        </div>
                    </div>
