            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <select name="inputBlogCategory" class="form-control col-md-7 col-xs-12">
								<?php foreach($blogCategoryList as $row){ ?>
									<option value="<?php echo $row['blog_category_id']?>"><?php echo $row['category_name']; ?></option>
								<?php } ?>
						   </select>
                        </div>
                    </div>
					...
					<div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputBlogUrl" id="inputBlogUrl" class="form-control cForm">
                        </div>
                    </div>
					<div class="item form-group">
                    ...
                    <!--<div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="file" name="inputSmallImage" class="form-control cForm">
                        </div>
                    </div>-->
