...
<html lang="en">
    ...
    <head>
        ...
        <title>Administrator | Shyam Future Tech LLP </title>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            ...
                            <div class="menu_section ">
                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-pencil-square-o "></i> PAGES <span class="fa fa-chevron-down"></span></a>
                                   ...
                                   <!-- <li><a><i class="fa fa-picture-o "></i> Banner <span class="fa fa-chevron-down"></span></a>
                                    ...
                                    <li><a><i class="fa fa-picture-o "></i> IMAGES <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            <li><a href="<?php echo base_url() . "admin/images"; ?>">List</a>
                                            </li>
