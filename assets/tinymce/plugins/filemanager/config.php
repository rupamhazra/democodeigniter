...
$base_url ="http://telmaconline.in"; //url base of site if you want only relative url leave empty Exam:> http://abc.in
$upload_dir = '/wbsidcl-website/assets/tinymce/source/'; // path from base_url to upload base dir Exam:> /assets/tinymce/source
$current_path = '../../../../source/'; // relative path from filemanager folder to upload files folder Exam:> ../../../../source/
