...
$root = rtrim($_SERVER['DOCUMENT_ROOT'],'/ethical/assets/tinymce/'); // don't touch this configuration
...
$base_url ="http://localhost/ethical"; //url base of site if you want only relative url leave empty
$upload_dir = '/ethical/assets/tinymce/source'; // path from base_url to upload base dir
